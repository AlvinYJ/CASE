...
The incorrect certificate CP items were as follows, with the second PolicyInformation's policyIdentifier being the EV OID but without a value for the cpsURI:
...
| Rebuild the lint tool to integrate zlint, pkilint, and certlint, including SHECA's custom lint extensions, as outlined in the previous case | *Detect*  | 2024-06-28   |
