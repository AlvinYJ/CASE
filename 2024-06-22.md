...
We use zlint as our detection tool and regularly update its versions. However, zlint does not support checking for this specific error because it is not a requirement explicitly defined in the BR. We have already raised an issue with zlint regarding this.
